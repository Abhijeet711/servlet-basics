 ...
 * @author Abhi
 */
public class sessioncookies1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Servlet sessioncookies1</title>");            
            out.println("</head>");
            out.println("<body><center>");
            //out.println("<h1>Servlet sessioncookies1 at " + request.getContextPath() + "</h1>");
